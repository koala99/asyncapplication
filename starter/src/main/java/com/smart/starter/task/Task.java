...
import com.smart.starter.utils.DispatcherExecutor;
...
public abstract class Task implements ITask {
    ...
    protected Application mApplication = LauncherStarter.getContext();
    protected boolean mIsMainProcess = LauncherStarter.isMainProcess();// 当前进程是否是主进程
