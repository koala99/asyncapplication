...
import com.smart.starter.sort.TaskSortUtil;
import com.smart.starter.stat.TaskStat;
import com.smart.starter.task.DispatchRunnable;
import com.smart.starter.task.Task;
import com.smart.starter.task.TaskCallBack;
import com.smart.starter.utils.DispatcherLog;
...
public class LauncherStarter {
    ...
    public static void init(Application application) {
        if (application != null) {
            ...
            sHasInit = true;
            sIsMainProcess = Looper.getMainLooper() == Looper.myLooper();
        }
    }
